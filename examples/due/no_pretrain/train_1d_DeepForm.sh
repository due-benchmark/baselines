...
--label_smoothing 0 \
--model_type=t5  \
--data_dir ${DATASETS_ROOT}/DeepForm/${OCR_ENGINE}/train \
--val_data_dir ${DATASETS_ROOT}/DeepForm/${OCR_ENGINE}/dev \
--test_data_dir  ${DATASETS_ROOT}/DeepForm/${OCR_ENGINE}/test \
--gpus 8 \
--num_workers 16 \
--train_batch_size 1 \
--eval_batch_size 1 \
